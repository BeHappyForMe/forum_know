...
def tokenize2num(en_sentences,cn_sentences,en_word2idx,cn_word2idx):
...
def main():
    ...
    if args.do_translate:
        ...
        while True:
            ...
            translation = [processor.cn_tokenizer.id2word[i] for i in translation.data.cpu().numpy().reshape(-1)]
